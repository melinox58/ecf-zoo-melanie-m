 ...
 */
final class Version20250107203615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reports_vet (id INT AUTO_INCREMENT NOT NULL, id_animals_id INT DEFAULT NULL, id_foods_id INT DEFAULT NULL, id_users_id INT NOT NULL, id_habitats_id INT DEFAULT NULL, date DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, INDEX IDX_DAA9D133B6A11E8F (id_animals_id), INDEX IDX_DAA9D1332B19D99E (id_foods_id), INDEX IDX_DAA9D133376858A8 (id_users_id), INDEX IDX_DAA9D1332DC10B02 (id_habitats_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
