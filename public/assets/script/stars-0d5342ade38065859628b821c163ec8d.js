document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initialisation des étoiles au chargement
    initializeStars();

    // Si vous voulez réinitialiser après l'envoi du formulaire et rechargement du modal
    const form = document.querySelector('form');
    if (form) {
        form.addEventListener('submit', function () {
            setTimeout(initializeStars, 1000);  // Attendre un délai pour réinitialiser les étoiles après l'envoi du formulaire
        });
    }
});
